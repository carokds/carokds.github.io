---
layout: post
title: "Trámites, nunca se terminan"
date: 2019-05-04
tags:
  - trámite
  - post
  ...
  - viaje
description: 
image: /assets/images/posts/trámites.jpg
---
  En este posteo escribo sobre todos los trámites que hicimos en Buenos Aires, previos al viaje, y los que seguimos acá en Barcelona.

  * Turnos: cómo y dónde gestionarlos.
  * Legalizaciones: qué documentos se tienen que legalizar y cuáles no.
  * Apostillas 
  * Traer a Cocó
  * NIE
  * Asignación de número de Seguridad Social
  * Apertura de cuenta en un Banco
  * Buscar un piso
  * Empadronamiento
  * Tarjeta de Familiar Comunitario
  * Y más trámites (porque nunca se terminan).
